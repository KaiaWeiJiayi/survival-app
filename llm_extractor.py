...
def extract_data_from_km_image(image_file):
    ...
    """
    # Use Gemini 1.5 Flash for fast and highly capable image understanding
    model = genai.GenerativeModel('gemini-1.5-flash')

    # Core prompt engineering: Specify the exact format of the requested data
    prompt = """
    ...
    try:
        ...
        # Call the model to generate content based on the prompt and image
